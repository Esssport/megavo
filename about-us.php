    ...
    <section id="about-us">
        <div class="container">
			<div class="center wow fadeInDown">
				<h2>About Megavo Workforce</h2>
				<p class="lead">We are the best at what we do, <br> Not a single unsatisfied customer so far!</p>
			</div>
			...
			<div class="skill-wrap clearfix">
				...
				<div class="center wow fadeInDown">
					<h2>Our Skill</h2>
					<p class="lead">We are competent in this field <br> We require the best out of our employees</p>
				</div>
