    ...
    <section id="feature" class="transparent-bg">
        <div class="container">
           <div class="center wow fadeInDown">
                <h2>Our Services</h2>
                <p class="lead">We have a variety of services <br> that will be available at your request</p>
            </div>
            ...
            <div class="get-started center wow fadeInDown">
                ...
                <p class="lead">Do you want to see how much it will cost you to use our services? <br> Just click on the link below to get a free estimation of the price. Don't hesitate to ask for further clarification.</p>
                <div class="request">
